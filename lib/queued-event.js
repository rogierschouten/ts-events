        ...
        if (this._condensed) {
            ...
            if (this._queued) {
                ...
                queue.add(function () {
                    ...
                    for (var i = 0; i < listeners.length; ++i) {
                        ...
                        if (!listener.deleted) {
                            listener.handler.apply((typeof listener.boundTo === "object" ? listener.boundTo : _this), data);
                        }
                    }
                });
            }
            ...
            queue.add(function () {
                for (var i = 0; i < listeners.length; ++i) {
                    var listener = listeners[i];
                    if (!listener.deleted) {
                        listener.handler.apply((typeof listener.boundTo === "object" ? listener.boundTo : _this), args);
                    }
                }
            });
        }
